...
{{-- Use original search bar for better UI use yield for different page different search form --}}
@section('searchbar')
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item pending-btn @if ($row->status == 0) active @endif" href="#">pending</a></li>
                                        <li><a class="dropdown-item success-btn @if ($row->status == 1) active @endif" href="#">success</a></li>
                                        <li><a class="dropdown-item reject-btn @if ($row->status == 2) active @endif" href="#">reject</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
