                    ...
                    <tbody class="align-middle">
                        @foreach ($data as $row)
                            <tr class=" product-row">
                                ...
                                <td class="align-middle tableEachTotal">Rp {{ number_format($row->qty * $row->price, 0, ',', '.') }}</td>
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pb-2">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <h6 class="font-weight-medium">Rp 8,000</h6>
                        </div>
                    </div>
                    <div class="pt-2">
                        <div class="d-flex justify-content-between mt-2">
                            <h5>Total</h5>
                            <h5 id='finalTotal'>Rp 0</h5>
                        </div>
...
@section('scriptSource')
    <script>
            ...
            let getSubTotal = function(){
                ...
                $('#subTotal').html('Rp '+ subTotal.toLocaleString('id-ID'));//to insert subtotal
                $('#finalTotal').html('Rp '+ (subTotal + 8000).toLocaleString('id-ID'));// all cost with delivery fee
            }
            ...
            let mainProcess = function(i){
                let total = (Number(countGroup[i].value) * Number(productPrice[i].value));
                    tableEachTotal[i].innerText = ('Rp '+ total.toLocaleString('id-ID'));
