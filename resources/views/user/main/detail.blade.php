                                ...
                                <div class="col-lg-6 h-auto mb-30">
                                    <div class="h-100 bg-light p-30">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            <h3 class="font-weight-semi-bold">Rp {{ number_format($data->price, 0, ',', '.') }}</h3>
                                            <h5 class="text-muted ml-2"><del>Rp {{ number_format($data->price + 40000, 0, ',', '.') }}</del></h5>
                                        </div>
                            ...
                            <div class="product-item bg-light mb-3">
                                ...
                                <div class="text-center py-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-1">
                                        <h4>Rp {{ number_format($row->price, 0, ',', '.') }}</h4><h6 class="text-muted ml-2"><del>Rp {{ number_format($row->price + 40000, 0, ',', '.') }}</del></h6>
                                    </div>
